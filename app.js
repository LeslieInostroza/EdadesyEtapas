...
if ( age >= 1 && age <= 2) {
    document.write("<div>" + age + " años" +  " = Toddler</div>");
    
    alert('Perteneces a Toddler');
} else if (age >= 3 && age <= 4){
    document.write("<div>" + age + " años" + " = Preschool</div>");
    alert('Perteneces a Preschool')

} else if (age >=5 && age <=11){
    document.write("<div>"  + age + " años" + " = Gradeschooler</div>");
    alert('Perteneces a Gradeschooler')

} else if (age >=12 && age <= 17){
    document.write("<div>" + age + " años" + " = Teen.</div>");
